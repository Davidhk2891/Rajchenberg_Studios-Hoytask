...
class SetBottomSheetDialogAdapter(private val listener: OnItemClickListener) : ListAdapter<TaskSet, SetBottomSheetDialogAdapter.TaskToSetBottomSheetDialogViewHolder>(
    DiffCallback()
){
